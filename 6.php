...
<body>
    <form action="6.php" method="POST" enctype="multipart/form-data">
        ...
        <p name='answer'>
            Число 1: <?php echo $num_1?> 2 степень: <?php echo PowerA3($num_1) ?><br/>
            Число 2: <?php echo $num_2?> 2 степень: <?php echo PowerA3($num_2)?><br/>
            Число 3: <?php echo $num_3?> 2 степень: <?php echo PowerA3($num_3)?><br/>
            Число 4: <?php echo $num_4?> 2 степень: <?php echo PowerA3($num_4)?><br/>
            Число 5: <?php echo $num_5?> 2 степень: <?php echo PowerA3($num_5)?><br/>
        </p>
</body>
</html>
